...
if __name__ == '__main__':
    ...
    posimp,func,args,colorbnd,structname,nd,selecm=3823,DEDlib.GrapheneNRarmchairstruct,(41,40,-40.991869112463434),7647,'LargeStruct',np.zeros((4,2),dtype = 'float'),['','eigval']
