...
if __name__ == '__main__':
    ...
    input=tqdm([[{"N" : 200, "poles" : 4, "U" : 0, "Sigma" : 0, "Ed" : 0, "ctype" : 'n', "bound" : 8, "eigsel" : True}],[{"N" : 200, "poles" : 4, "U" : 0, "Sigma" : 0, "Ed" : 0, "ctype" : 'n', "bound" : 8, "eigsel" : False}]],position=0,leave=False,desc='No. selection type sims',bar_format='{l_bar}{bar:10}{r_bar}{bar:-10b}')
    for l,inp in enumerate(input):
        radius,colorbnd,ip,nd,selecm=tqdm([2.3,3.1,4.042,5.1],position=1,leave=False,desc='No. Graphene circular NR SAIM DED sims',bar_format='{l_bar}{bar:10}{r_bar}{bar:-10b}'),[19,37,61,91],[9,18,30,45],np.zeros((5,4),dtype = 'float'),['','eigval']
